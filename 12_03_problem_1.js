let input = '...317..........214.....................................751.................................630...479..205....41.993............416.........\n'+
...
const BOX_INDICES = [1, 140, 141, 142, -1, -140, -141, -142];

let sumPartNumbers = function(input) {
  let partsNumbers = [...input.matchAll(/\d+/g)];
  let tally = partsNumbers.reduce((sum, matchData) => {
    return sum += surroundedBySymbols(matchData) ? +matchData[0] : 0;
  }, 0)

  return tally
}

let surroundedBySymbols = function(matchData) {
  let string = matchData['input'];
  let indices = indexList(matchData[0], matchData['index']);
  for (i of indices) {
    for (point of BOX_INDICES) {
      if (/[^\.0-9a-z\n]/.test(String(string[i + point]))) return true;
    }
  }
...
let indexList = function(match, index) {
  let indices = [];
  let maxIndex = index + match.length - 1;
